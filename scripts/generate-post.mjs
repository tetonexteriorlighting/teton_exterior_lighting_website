...
async function main() {
  ...
  const topicContext = customTopic
    ...
    : `Choose a topic relevant to ${season} for homeowners in the Intermountain West (Idaho Falls, Jackson Hole, Pocatello, Rexburg, Rigby). Pick something a homeowner would actually search for this time of year.`;
...
- Serves: Idaho Falls, Rexburg, Rigby, Pocatello, Jackson Hole WY, Twin Falls ID
- Phone: (208) 557-9009
